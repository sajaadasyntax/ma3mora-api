// Image 1: Bakery customers/sales orders
const image1Data = [
...
// Combine both images
const imageData = [...image1Data, ...image2Data];
...
console.log('Comparing bakery customers from images with seed file...\n');
